from validation import get_vm_input #,Name_Validation,OS_Validation,CPU_Validation,GPU_Validation,RAM_Validation,Disk_Validation,IP_Validation
...
while True:
    ...
    if answer == "yes":
        ...
        if data:
            ...
            vm = VM(data.Name,data.OS,data.CPU,data.GPU,data.RAM,data.Disk,data.IP)
